...
public interface DirectorioService {
	 ...
	 * nombre el filtro obtenido como par�metro.
	 * 
	 * @param filtroNombre
	...
	/**
	 * Devuelve el {@link Directorio} que tenga el ID obtenido como par�metro.
	 * 
	 * @param id
	...
	/**
	 * Actualiza la informaci�n de un {@link Directorio} existente.
	 * 
	 * @param editor
